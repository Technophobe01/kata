...
| Version | Change |
| --- | --- |
| `0.5.0` | Added issue create metadata and metadata-key filters on project issue lists. Generated clients can send initial metadata in create requests and request selected metadata keys with the `meta` query parameter. |
